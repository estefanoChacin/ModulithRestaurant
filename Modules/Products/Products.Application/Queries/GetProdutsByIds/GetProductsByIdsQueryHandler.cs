...
public class GetProductsByIdsQueryHandler(IProductRepository productRepository, IMapper mapper, ILogger<GetProductsByIdsQueryHandler> logger) : IRequestHandler<GetProductsByIdsQuery, List<ProductDto>>
{
